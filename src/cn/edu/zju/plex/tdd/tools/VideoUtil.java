...
public class VideoUtil {
	...
	public static Video getTudouVideo(String url) throws Exception {
		...
		int endLocal = content.indexOf("</script>", 100);
		System.out.println("here" + beginLocal + "," + endLocal);
		content = content.substring(beginLocal, endLocal);
		System.out.println("sampledoc:" + content);
		/**
		 * 获取视频地址
		 */
	...
	public static void main(String[] args) {
		String url = "http://v.youku.com/v_show/id_XMzk4NDg2NzU2.html";
